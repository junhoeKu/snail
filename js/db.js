...
const DB = (function () {
  ...
  const VALID_COLORS = ['brown', 'gray', 'red', 'yellow', 'bluegray', 'lavender', 'herb', 'black', 'lime', 'sky', 'pond', 'maple', 'pinwheel', 'cherry', 'sunflower', 'bee', 'devil', 'angel', 'ladybug']; // GAME.VARIANTS 키와 일치
